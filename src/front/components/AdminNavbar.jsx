...
export const AdminNavbar = () => {
    ...
    const adminInitial = loggedAdmin?.name?.charAt(0)?.toUpperCase() || "A";

    return (
        <header className="topnav">
            <div className="d-flex align-items-center gap-3">
                <Link to="/administradores" className="topnav-brand">
            ...
            <div className="d-flex align-items-center gap-3">
                ...
                <div className="user-chip">
                    ...
                    <div>
                        <div className="user-name">{loggedAdmin?.name || "Administrador"}</div>
