...
export const LinerNavbar = ({ liner, onLogout }) => {
    ...
    return (
        <header className="topnav">
            ...
            <div className="d-flex align-items-center gap-3">
                <button
                    className="btn-icon-outline position-relative border-0"
                    style={{ background: "none" }}
                    type="button"
                >
                    <i className="bi bi-bell fs-5" style={{ color: "#6b7a99" }}></i>
                    <span
                ...
                <div className="user-chip">
                    ...
                    <div>
                        <div className="user-name">{liner?.nombre || "Liner"}</div>
                        <div className="user-role">Liner</div>
                    </div>
                </div>
