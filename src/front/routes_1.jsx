...
export const router = createBrowserRouter(
    createRoutesFromElements(
        <>
            {/* RUTAS CON NAVBAR/FOOTER GENERICO */}
            ...
            {/* RUTAS SIN NAVBAR/FOOTER GENERICO */}
            <Route path="/" element={<CleanLayout />} errorElement={<h1>Not found!</h1>}>
                {/* Auth */}
