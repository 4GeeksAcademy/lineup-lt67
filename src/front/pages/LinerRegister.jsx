    ...
    return (
        <div style={{ minHeight: "100vh", background: "var(--surface)" }}>
            <header className="topnav" style={{ position: "sticky" }}>
                ...
                <div className="d-flex align-items-center gap-3">
                    <Link to="/liner/login" className="btn-page" style={{ textDecoration: "none" }}>
                        Ya tengo cuenta
                    </Link>
                </div>
            </header>
            ...
            >
                ...
                >
                    ...
                    >
                        Registrate para empezar a ver servicios cercanos y trabajar con clientes.
                    </p>
                </div>
            </div>
        </div>
