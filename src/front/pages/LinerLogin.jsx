    ...
    return (
        <div style={{ minHeight: "100vh", background: "var(--surface)" }}>
            <header className="topnav" style={{ position: "sticky" }}>
                ...
                <div className="d-flex align-items-center gap-3">
                    <Link to="/liner/register" className="btn-page" style={{ textDecoration: "none" }}>
                        Crear cuenta
                    </Link>
                </div>
            </header>
            ...
            >
                ...
                >
                    <div style={{ maxWidth: "480px", width: "100%" }}>
                        <div className="fw-bold mb-4" style={{ fontSize: "1.3rem" }}>
                            Iniciar sesión como liner
                        </div>
                ...
                >
                    ...
                    >
                        Iniciá sesión para ver servicios cercanos, enviar propuestas y chatear con clientes.
                    </p>
                </div>
            </div>
        </div>
