        ...
        <div style={{ minHeight: "100vh", background: "var(--surface)" }}>
            ...
            >
                ...
                >
                    <div style={{ maxWidth: "480px", width: "100%" }}>
                        ...
                        <p className="text-muted mb-4" style={{ fontSize: ".92rem" }}>
                            Ingresá al panel para gestionar usuarios, tickets, servicios y recursos del sistema.
                        </p>
                ...
                >
                    ...
                    >
                        Accedé a una vista integral del sistema para crear, editar y supervisar todos los recursos de la aplicación.
                    </p>
                </div>
            </div>
        </div>
